...
public class QueryMyProduct extends HttpServlet {
	private static final long serialVersionUID = 6620907933637190944L;
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			ArrayList<MyProduct> myProducts = DAOFactory.getIDAOInstance().queryMyProduct(user);
			...
			if(myProducts.size()>0){
				...
				map.put(MyProduct.TAG, myProducts);
			}else {
